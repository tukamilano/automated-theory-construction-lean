...
- `Themes`
  - 2-5 items.
  - Each item should name a major organizing concern of the theory.
...
- Let `Anti-Goals` sound like explicit exclusion criteria for work that does not materially advance the theory.
