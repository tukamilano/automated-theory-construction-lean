...
def main() -> int:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        memory_file = data_dir / "formalization_memory.json"
        theory_state_file = data_dir / "theory_state.json"
        ...
        write_jsonl_atomic(data_dir / "solved_problems.jsonl", [{"id": "op_000007", "stmt": "solved", "thm": "thm"}])
        write_jsonl_atomic(data_dir / "counterexamples.jsonl", [{"id": "op_000041", "stmt": "cex"}])
        (data_dir / "theorem_reuse_memory.json").write_text('{"entries":[{"candidate_id":"x"}]}\n', encoding="utf-8")
        ...
        write_jsonl_atomic(data_dir / "open_problems.jsonl", [{"id": "op_000001", "stmt": "seed"}])
        ...
        archived_rows = run_loop.read_jsonl(data_dir / "archived_problems.jsonl")
        solved_rows = run_loop.read_jsonl(data_dir / "solved_problems.jsonl")
        counter_rows = run_loop.read_jsonl(data_dir / "counterexamples.jsonl")
