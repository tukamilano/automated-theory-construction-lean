...
`.agents/shared/workflow/proof-planning.md` is only for **proof planning and replanning**.
...
1. Plan via `.agents/shared/workflow/proof-planning.md` Part 1.
...
10. If stuck, re-plan with `.agents/shared/workflow/proof-planning.md` Part 2.
...
Replan with `.agents/shared/workflow/proof-planning.md` Part 2 if any holds:
