# Shared Lean Workflow (ATC)

This repository uses Lean 4 + Mathlib for automated theory construction in an equational setting.

This file is the authoritative shared runtime instruction set for this repository.
...
- For Lean import issues, Mathlib import issues, or import-minimization decisions, always consult `.agents/shared/skills/mathlib-usage/SKILL.md`.
...
Use repository-local shared skills under `.agents/shared/skills/` as supporting guidance:
